...
const Profil = () => {
  ...
  const hasChanges = () => {
    return (
      formData.nom !== originalUser.nom ||
      formData.prenom !== originalUser.prenom ||
  ...
  const isPasswordValid = () => {
    return (
      passwordData.ancien.trim() !== '' &&
      passwordData.nouveau.trim() !== '' &&
      passwordData.nouveau === passwordData.confirm &&
  ...
  const handleSubmitPassword = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`http://localhost:3000/users/${user.id_utilisateur}/password`, {
        ...
        body: JSON.stringify({
          oldPassword: passwordData.ancien,
  ...
  return (
    <div className="profil-container">
      <div className="profil-header">
        <h1>Mon Profil</h1>
        <p className="subtitle">Gérez vos informations personnelles et votre sécurité</p>
      </div>
      ...
      <div className="profil-grid">
        <div className="avatar-card">
          ...
          <div className="avatar-wrapper">
            <div
              className={`avatar-circle ${avatarPreview ? 'has-photo' : ''}`}
              onClick={openZoom}
            >
              {avatarPreview ? (
            ...
            {avatarFile && (
              <button className="btn-avatar-save" onClick={handleAvatarUpload} disabled={uploading}>
            ...
            <form onSubmit={handleSubmitPassword}>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  required
                />
                {passwordData.nouveau && (
                  <small className={passwordStrength.valid ? 'success-message' : 'error-message'}>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  required
                />
                {passwordData.nouveau && passwordData.confirm && passwordData.nouveau !== passwordData.confirm && (
                  <small className="error-message">Les mots de passe ne correspondent pas</small>
                )}
              </div>
              <button
                type="submit"
              ...
              >
                <FaCheck style={{ marginRight: '0.5rem' }} /> Changer le mot de passe
              </button>
            </form>
          </div>
        </div>
        ...
        <div className="zoom-overlay" onClick={closeZoom}>
          <div className="zoom-modal" onClick={(e) => e.stopPropagation()}>
            <div className="zoom-circle">
              <img src={avatarPreview} alt="zoom" />
            </div>
